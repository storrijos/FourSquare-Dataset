...
do
  ...
  echo "Convoy"
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_1_2_0.1_T.txt --minpoints 1 --lifetime 2 --distance_max 0.1 --partials False &
  ...
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_5_2_0.1_T.txt --minpoints 5 --lifetime 2 --distance_max 0.1 --partials False &
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_10_2_0.1_T.txt --minpoints 10 --lifetime 2 --distance_max 0.1 --partials False &
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_3_5_0.1_T.txt --minpoints 3 --lifetime 5 --distance_max 0.1 --partials False &
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_3_10_0.1_T.txt --minpoints 3 --lifetime 10 --distance_max 0.1 --partials False &
  python3 src/Patterns/Convoy/ConvoyTrajectory.py --filename $training --output $patternneigh_folder"/"$filename"__"convoy_3_5_1_T.txt --minpoints 3 --lifetime 5 --distance_max 1 --partials False &
  ...
  echo "Flock"
  python3 src/Patterns/Flock/fpFlockOnline.py --filename $training --output $patternneigh_folder"/"$filename"__"flock_0.1_2_2.txt --epsilon 0.1 --mu 2 --delta 2
  ...
  python3 src/Patterns/Flock/fpFlockOnline.py --filename $training --output $patternneigh_folder"/"$filename"__"flock_0.1_5_2.txt --epsilon 0.1 --mu 5 --delta 2
  python3 src/Patterns/Flock/fpFlockOnline.py --filename $training --output $patternneigh_folder"/"$filename"__"flock_0.1_10_2.txt --epsilon 0.1 --mu 10 --delta 2
  ...
  python3 src/Patterns/Flock/fpFlockOnline.py --filename $training --output $patternneigh_folder"/"$filename"__"flock_0.1_2_100.txt --epsilon 0.1 --mu 2 --delta 100
  ...
  echo "Partials"
  ##Convoy Partials
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_1_2_0.1_T.txt --k 100 --minpoints 1 --lifetime 2 --distance_max 0.1 --partials False
  ...
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_5_2_0.1_T.txt --k 100 --minpoints 5 --lifetime 2 --distance_max 0.1 --partials False
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_10_2_0.1_T.txt --k 100 --minpoints 10 --lifetime 2 --distance_max 0.1 --partials False
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_3_5_0.1_T.txt --k 100 --minpoints 3 --lifetime 5 --distance_max 0.1 --partials False
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_3_10_0.1_T.txt --k 100 --minpoints 3 --lifetime 10 --distance_max 0.1 --partials False
  python3 src/Patterns/Convoy/convoy_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"convoy_partials_3_5_1_T.txt --k 100 --minpoints 3 --lifetime 5 --distance_max 1 --partials False

  ## Flock Partials
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_2_2.txt --k 100 --epsilon 0.1 --mu 2 --delta 2
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_10_2_2.txt --k 100 --epsilon 10 --mu 2 --delta 2
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_5_2.txt --k 100 --epsilon 0.1 --mu 5 --delta 2
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_10_2.txt --k 100 --epsilon 0.1 --mu 10 --delta 2
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_2_1.txt --k 100 --epsilon 0.1 --mu 2 --delta 1
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_2_10.txt --k 100 --epsilon 0.1 --mu 2 --delta 10
  python3 src/Patterns/Flock/flock_partial.py --dataset $training --similarity_file $patternneigh_folder"/"$filename"__"adhoc_3600.txt --output $patternneigh_folder"/"$filename"__"flock_partials_0.1_2_100.txt --k 100 --epsilon 0.1 --mu 2 --delta 100
...
if [ "$sim_avg" = TRUE ] ; then
  # obtain neighbors
  patternneigh_folder="pattern_neigh_circle_20K"
