...
python3 src/Patterns/ST_DBSCAN/main_stdbscan.py --filename ~/PycharmProjects/recommender/entradas/Datasets/US_NewYork_POIS_Coords_short.txt --neighbors_classified st_dbscan.txt --spatial_thresold 5000 --temporal_threshold 6000 --min_neighbors 1
